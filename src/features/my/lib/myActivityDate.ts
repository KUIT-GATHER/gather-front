...
function normalizeMyActivityTime(time: string | null) {
...
export function formatMyActivityTimeRange(
  startTime: string | null,
  endTime: string | null,
) {
  const formattedStartTime = normalizeMyActivityTime(startTime);
  const formattedEndTime = normalizeMyActivityTime(endTime);
